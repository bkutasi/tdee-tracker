...
const WeeklyView = (function () {
    ...
    function render() {
        try {
            ...
            if (!tbody) {
                console.warn('WeeklyView.render: table body not found');
                return;
            }
            ...
            console.error('WeeklyView.render:', error);
            Components.showError('Failed to load weekly view. Please refresh.', 'WeeklyView');
        }
    }
    ...
    function renderSummary(entries, weightUnit) {
        try {
            ...
            console.error('WeeklyView.renderSummary:', error);
            Components.showError('Failed to load weekly summary', 'WeeklyView');
        }
    }
     ...
     * @returns {Date} Start date of the current week (Monday)
     */
